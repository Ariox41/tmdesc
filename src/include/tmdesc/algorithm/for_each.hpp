...
public:
    ...
    constexpr void operator()(Tuple&& t, Fn&& fn) const
        noexcept(noexcept(impl_t{}(std::declval<Tuple>(), std::declval<Fn>(), index_sequence_for_tuple<Tuple>{}))) {
...
public:
    ...
    constexpr void operator()(Tuple1&& t1, Tuple2&& t2, Fn&& fn) const
        noexcept(noexcept(impl_t{}(std::declval<Tuple1>(), std::declval<Tuple2>(), std::declval<Fn>(),
